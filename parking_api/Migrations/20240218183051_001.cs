        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CondoAdminId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    State = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Zip = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TowingDriverId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefaultMaxCarAllowed = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Condos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Condos_AspNetUsers_CondoAdminId",
                        column: x => x.CondoAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxCarsAllowed = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlateImgPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CarImgPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Archived = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    ResolvedStatus = table.Column<bool>(type: "bit", nullable: false),
                    ResolvedDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CamLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CamLogs_AspNetUsers_ResolvedById",
                        column: x => x.ResolvedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CamLogs_Cameras_CameraId",
                        column: x => x.CameraId,
                        principalTable: "Cameras",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CamLogs_Condos_CondoId",
                        column: x => x.CondoId,
                        principalTable: "Condos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CamLogs_Lots_LotId",
                        column: x => x.LotId,
                        principalTable: "Lots",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cameras_LotId",
                table: "Cameras",
                column: "LotId");

            migrationBuilder.CreateIndex(
                name: "IX_CamLogs_CameraId",
                table: "CamLogs",
                column: "CameraId");

            migrationBuilder.CreateIndex(
                name: "IX_CamLogs_CondoId",
                table: "CamLogs",
                column: "CondoId");

            migrationBuilder.CreateIndex(
                name: "IX_CamLogs_LotId",
                table: "CamLogs",
                column: "LotId");

            migrationBuilder.CreateIndex(
                name: "IX_CamLogs_ResolvedById",
                table: "CamLogs",
                column: "ResolvedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Condos_CondoAdminId",
                table: "Condos",
                column: "CondoAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Lots_CondoId",
                table: "Lots",
                column: "CondoId");

            migrationBuilder.CreateIndex(
                name: "IX_Units_CondoId",
                table: "Units",
                column: "CondoId");
